...
let BEHOLDER = Role(name: "Beholder", type: .Beholder, description: "During the first night, wake up and learn the identity of the Seer.", roleExplanation: "The Beholder learns who the Seer is on the first night. It's important to be careful how you use this information because you don't want to give the Seer away. You might try to secretly let the Seer know that you're on their team, but if you're not subtle about it and a Werewolf finds out, it could be disastrous for the village team. So caution is advised.", impact: 2, priority: 193, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "beholder"), isNightActiveRole: .NotNightActiveRole)



let BODYGUARD = Role(name: "Bodyguard", type: .Bodyguard, description: "Each night, choose a player, different from the previous night, to protect from elimination that night.", roleExplanation: "The Bodyguard chooses a player to protect each night. It cannot be the same player twice in a row; however, that player may choose the same person multiple times per game. That player is then protected from any type of elimination that night. The bodyguard may not choose to protect himself.", impact: 3, priority: 52, powerChoice: false, team: [.TeamVillage], availableEffects: [.Protection], image: #imageLiteral(resourceName: "bodyguard"), isNightActiveRole: .NightActiveRole)



let CULTLEADER = Role(name: "Cult Leader", type: .CultLeader, description: "Wake up every night and choose a player to join the cult. If all players in the game are part of the cult, the Cult Leader wins.", roleExplanation: "The Cult Leader wakes up each night and chooses a player to add to the cult. Players that have been chosen do not know they are in the cult - just like a real cult! The Cult Leader only wins - despite appearing as a villager - if all players left in the game are part of the cult. Other teams may still fulfill victory contidions. The Cult Leader does not need to be alive to win.", impact: 1, priority: 70, powerChoice: false, team: [.TeamCult], availableEffects: [], image: #imageLiteral(resourceName: "cultLeader"), isNightActiveRole: .NightActiveRole)



let CUPID = Role(name: "Eros", type: .Cupid, description: "Wake up on the first night and choose two players to be linked together. If one of them is eliminated, the other is eliminated as well.", roleExplanation: "The god-child Eros has assumed human disguise and walks, hidden, amongst the villagers. Eros wakes up during the first night and points at two players. He may choose himself, as one of the two players. The Moderator then wakes up the two lovebirds the first night by tapping them on the shoulder so they can see who the other sweetheart is. If either of the lovers is eliminated, for any reason, the other is also eliminated instantly, because of a broken heart.\n\nThe lovers fall under a few special victory conditions. If both lovers are on the village team, they win with the village team. Similarly, ff they are both on the werewolf team, they win with the werewolf team. However, if the two lovers find themselves on different teams, they relinquish all other ties, become their own team, and only win if they are the last two players in the game. Being a Lovebird overrides all other winning conditions.", impact: -3, priority: 76, powerChoice: false, team: [.TeamVillage], availableEffects: [.Lovestruck], image: #imageLiteral(resourceName: "cupid"), isNightActiveRole: .NotNightActiveRole)



let CURSED = Role(name: "Cursed", type: .Cursed, description: "Start on the village team. If eliminated by the werewolves, turn into a werewolf and join their team.", roleExplanation: "The Cursed was once hexxed by a travelling circus witch. They start the game on the village team and they act for the benefit of the village. That is, unless they are targeted for elimination by the werewolves, at which point they then join the werewolf team instead of being eliminated.\n\nEvery night, the Moderator should wake the Cursed to let them know if they have switched teams. Once the Cursed has switched teams, the Moderator should continue to call the role, so the players do not know he has been changed.).", impact: -3, priority: 5, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "cursed"), isNightActiveRole: .NightActiveRole)
...
let VILLAGER_ONE = Role(name: "Villager", type: .Villager, description: "Find the werewolves and eliminate them.", roleExplanation: "Villager’s sole purpose is to find the Werewolves and eliminate them.", impact: 3, priority: 250, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "villager"), isNightActiveRole: .NotNightActiveRole)

let VILLAGER_TWO = Role(name: "Villager", type: .Villager, description: "Find the werewolves and eliminate them.", roleExplanation: "Villager’s sole purpose is to find the Werewolves and eliminate them.", impact: 3, priority: 251, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "villager"), isNightActiveRole: .NotNightActiveRole)

let VILLAGER_THREE = Role(name: "Villager", type: .Villager, description: "Find the werewolves and eliminate them.", roleExplanation: "Villager’s sole purpose is to find the Werewolves and eliminate them.", impact: 3, priority: 252, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "villager"), isNightActiveRole: .NotNightActiveRole)

let VILLAGER_FOUR = Role(name: "Villager", type: .Villager, description: "Find the werewolves and eliminate them.", roleExplanation: "Villager’s sole purpose is to find the Werewolves and eliminate them.", impact: 3, priority: 253, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "villager"), isNightActiveRole: .NotNightActiveRole)

let VILLAGER_FIVE = Role(name: "Villager", type: .Villager, description: "Find the werewolves and eliminate them.", roleExplanation: "Villager’s sole purpose is to find the Werewolves and eliminate them.", impact: 3, priority: 254, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "villager"), isNightActiveRole: .NotNightActiveRole)

let VILLAGER_SIX = Role(name: "Villager", type: .Villager, description: "Find the werewolves and eliminate them.", roleExplanation: "Villager’s sole purpose is to find the Werewolves and eliminate them.", impact: 3, priority: 255, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "villager"), isNightActiveRole: .NotNightActiveRole)

let VILLAGER_SEVEN = Role(name: "Villager", type: .Villager, description: "Find the werewolves and eliminate them.", roleExplanation: "Villager’s sole purpose is to find the Werewolves and eliminate them.", impact: 3, priority: 256, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "villager"), isNightActiveRole: .NotNightActiveRole)

let VILLAGER_EIGHT = Role(name: "Villager", type: .Villager, description: "Find the werewolves and eliminate them.", roleExplanation: "Villager’s sole purpose is to find the Werewolves and eliminate them.", impact: 3, priority: 257, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "villager"), isNightActiveRole: .NotNightActiveRole)

let VILLAGER_NINE = Role(name: "Villager", type: .Villager, description: "Find the werewolves and eliminate them.", roleExplanation: "Villager’s sole purpose is to find the Werewolves and eliminate them.", impact: 3, priority: 258, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "villager"), isNightActiveRole: .NotNightActiveRole)

let VILLAGER_TEN = Role(name: "Villager", type: .Villager, description: "Find the werewolves and eliminate them.", roleExplanation: "Villager’s sole purpose is to find the Werewolves and eliminate them.", impact: 3, priority: 259, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "villager"), isNightActiveRole: .NotNightActiveRole)

let VILLAGER_ELEVEN = Role(name: "Villager", type: .Villager, description: "Find the werewolves and eliminate them.", roleExplanation: "Villager’s sole purpose is to find the Werewolves and eliminate them.", impact: 3, priority: 260, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "villager"), isNightActiveRole: .NotNightActiveRole)

let VILLAGER_TWELVE = Role(name: "Villager", type: .Villager, description: "Find the werewolves and eliminate them.", roleExplanation: "Villager’s sole purpose is to find the Werewolves and eliminate them.", impact: 3, priority: 261, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "villager"), isNightActiveRole: .NotNightActiveRole)

let VILLAGER_THIRTEEN = Role(name: "Villager", type: .Villager, description: "Find the werewolves and eliminate them.", roleExplanation: "Villager’s sole purpose is to find the Werewolves and eliminate them.", impact: 3, priority: 262, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "villager"), isNightActiveRole: .NotNightActiveRole)
