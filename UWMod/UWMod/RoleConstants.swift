...
let MASON_ONE = Role(name: "Mason", type: .Mason, description: "The first night, wake up to see who the other Mason is.", roleExplanation: "The first night the Moderator calls for the Masons to open their eyes and look for the other Masons. No one in the Village may directly or indirectly speak of the Masons, or the players that speak of them are eliminated that night by the secret society in order to keep it a secret. If they are eliminated by the secret society, they automatically lose, even if they are on a winning team.\n\nThe moderator needs to use discretion here; it's much better for gameplay if the subject is never discussed directly or indirectly by the players. If a player says, 'Well, Bobby knew Joe was safe, but Bobby's not the Seer,' that's a clear reference to the Masons, so that player should be eliminated. Players will only make this mistake once.", impact: 2, priority: 121, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "mason"), isNightActiveRole: .NotNightActiveRole)

let MASON_TWO = Role(name: "Mason", type: .Mason, description: "The first night, wake up to see who the other Mason is.", roleExplanation: "The first night the Moderator calls for the Masons to open their eyes and look for the other Masons. No one in the Village may directly or indirectly speak of the Masons, or the players that speak of them are eliminated that night by the secret society in order to keep it a secret. If they are eliminated by the secret society, they automatically lose, even if they are on a winning team.\n\nThe moderator needs to use discretion here; it's much better for gameplay if the subject is never discussed directly or indirectly by the players. If a player says, 'Well, Bobby knew Joe was safe, but Bobby's not the Seer,' that's a clear reference to the Masons, so that player should be eliminated. Players will only make this mistake once.", impact: 2, priority: 121, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "mason"), isNightActiveRole: .NotNightActiveRole)

let MASON_THREE = Role(name: "Mason", type: .Mason, description: "The first night, wake up to see who the other Mason is.", roleExplanation: "The first night the Moderator calls for the Masons to open their eyes and look for the other Masons. No one in the Village may directly or indirectly speak of the Masons, or the players that speak of them are eliminated that night by the secret society in order to keep it a secret. If they are eliminated by the secret society, they automatically lose, even if they are on a winning team.\n\nThe moderator needs to use discretion here; it's much better for gameplay if the subject is never discussed directly or indirectly by the players. If a player says, 'Well, Bobby knew Joe was safe, but Bobby's not the Seer,' that's a clear reference to the Masons, so that player should be eliminated. Players will only make this mistake once.", impact: 2, priority: 121, powerChoice: false, team: [.TeamVillage], availableEffects: [], image: #imageLiteral(resourceName: "mason"), isNightActiveRole: .NotNightActiveRole)
